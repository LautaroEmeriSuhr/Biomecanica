...
switch esttype
  case 'psd'
    [r, harmPow, harmFreq] = psdTHD(plotType, harmType, varargin{:});
  case 'power'
    [r, harmPow, harmFreq] = powerTHD(plotType, harmType, varargin{:});
  case 'time'
    [r, harmPow, harmFreq] = timeTHD(plotType, harmType, varargin{:});
end
...
[r, harmPow, harmFreq] = computeTHD(plotType, Pxx, F, rbw, nHarm, aliasFs);
...
[r, harmPow, harmFreq] = computeTHD(plotType, Sxx/rbw, F, rbw, nHarm, aliasFs);
...
[r, harmPow, harmFreq] = computeTHD(plotType, Pxx, F, mean(diff(F)), nHarm, aliasFs);
