classdef (CaseInsensitiveProperties=true, TruncatedProperties=true) peak < fdesign.abstractpeaknotch & dynamicprops
...
%fdesign.peak class
%   fdesign.peak extends fdesign.abstractpeaknotch.
%
%    fdesign.peak properties:
