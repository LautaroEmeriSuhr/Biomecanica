classdef (CaseInsensitiveProperties=true, TruncatedProperties=true) parameqmeas < fdesign.abstractparameqmeas & dynamicprops
%PARAMEQMEAS Construct a PARAMEQMEAS object.

%   Copyright 2004-2015 The MathWorks, Inc.
  
%fdesign.parameqmeas class
%   fdesign.parameqmeas extends fdesign.abstractparameqmeas.
%
%    fdesign.parameqmeas properties:
...
%       G0 - Property is of type 'mxArray' (read only) 
%       Gpass - Property is of type 'mxArray' (read only) 
%       Gstop - Property is of type 'mxArray' (read only) 
