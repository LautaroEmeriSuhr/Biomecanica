classdef (CaseInsensitiveProperties=true) parameq < fdesign.abstracttypewspecs & dynamicprops
...
%fdesign.parameq class
%   fdesign.parameq extends fdesign.abstracttypewspecs.
%
%    fdesign.parameq properties:
%       Response - Property is of type 'ustring' (read only) 
%       Description - Property is of type 'string vector' (read only) 
%       Specification - Property is of type 'parameqSpecTypes enumeration: {'F0,BW,BWp,Gref,G0,GBW,Gp','F0,BW,BWst,Gref,G0,GBW,Gst','F0,BW,BWp,Gref,G0,GBW,Gp,Gst','N,F0,BW,Gref,G0,GBW','N,F0,BW,Gref,G0,GBW,Gp','N,F0,BW,Gref,G0,GBW,Gst','N,F0,BW,Gref,G0,GBW,Gp,Gst','N,Flow,Fhigh,Gref,G0,GBW','N,Flow,Fhigh,Gref,G0,GBW,Gp','N,Flow,Fhigh,Gref,G0,GBW,Gst','N,Flow,Fhigh,Gref,G0,GBW,Gp,Gst','N,F0,Qa,Gref,G0','N,F0,Fc,Qa,G0','N,F0,Fc,S,G0'}'  
%
%    fdesign.parameq methods:
...
methods  % constructor block
  ...
  this.Response = 'Parametric Equalizer';
  
  this.Specification = 'F0,BW,BWp,Gref,G0,GBW,Gp';
