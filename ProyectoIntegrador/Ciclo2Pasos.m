function [Datos, DerechaPlataforma1,PrimerFrame,UltimoFrame,FrameRHS1,FrameLHS1,FrameRHS2,FrameLHS2,FrameRTO,FrameLTO]=Ciclo2Pasos(Datos);
...
FRate= Datos.Pasada.Marcadores.Frecuencia;
...
Datos.eventos.FrameLHS1 = FrameLHS1 - (FrameRHS1 - 10);
Datos.eventos.FrameLTO = FrameLTO - (FrameRHS1 - 10);
Datos.eventos.FrameLHS2 = FrameLHS2 - (FrameRHS1 - 10);
Datos.eventos.FrameRHS1 = FrameRHS1 - (FrameRHS1 - 10);
Datos.eventos.FrameRTO = FrameRTO - (FrameRHS1 - 10);
Datos.eventos.FrameRHS2 = FrameRHS2 - (FrameRHS1 - 10);
