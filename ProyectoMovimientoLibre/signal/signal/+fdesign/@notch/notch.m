classdef (CaseInsensitiveProperties=true, TruncatedProperties=true) notch < fdesign.abstractpeaknotch & dynamicprops
...
%fdesign.notch class
%   fdesign.notch extends fdesign.abstractpeaknotch.
%
%    fdesign.notch properties:
...
methods  % constructor block
  function this = notch(varargin)
    ...
    this.Response = 'Notching Filter';
  
    this.Specification = 'N,F0,Q';
