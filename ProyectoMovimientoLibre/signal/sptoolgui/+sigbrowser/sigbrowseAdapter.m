...
if numel(dpy)>0
  ...
  if allOn || allOff
    ...
    menu = g.findchild('Base/Menus/View/ToggleLegend');
    % set/unset if needed.
    if strcmp(menu.getWidgetProperty('Checked'),'on') && allOff
      menu.setWidgetProperty('Checked', 'off');
    elseif strcmp(menu.getWidgetProperty('Checked'),'off') && allOn
      menu.setWidgetProperty('Checked', 'on');
    end
  end
end
